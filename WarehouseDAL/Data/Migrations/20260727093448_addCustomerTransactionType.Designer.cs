...
namespace WarehouseDAL.Data.Migrations
{
    ...
    [Migration("20260727093448_addCustomerTransactionType")]
    partial class addCustomerTransactionType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.OpeningStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.Transactions.CustomerTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.CashBox", b =>
                {
                    b.HasOne("WarehouseDAL.Entities.Branch", "Branch")
                        .WithMany("CashBoxes")
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.PurchaseInvoiceItem", b =>
                {
                    ...
                    b.HasOne("WarehouseDAL.Entities.ProductUnit", "ProductUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.SalesInvoice", b =>
                {
                    ...
                    b.HasOne("WarehouseDAL.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseDAL.Entities.SalesInvoiceItem", b =>
                {
                    ...
                    b.HasOne("WarehouseDAL.Entities.SalesInvoice", "SalesInvoice")
