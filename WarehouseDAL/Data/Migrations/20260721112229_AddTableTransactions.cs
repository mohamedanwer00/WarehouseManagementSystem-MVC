    ...
    public partial class AddTableTransactions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashsTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CashsTransactions_CashBoxes_CashBoxId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remaining = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CusromerId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierTransactions_PurchaseInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerTransactions_SalesInvoices_SalesInvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashsTransactions_CashBoxId",
                table: "CashsTransactions",
                column: "CashBoxId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerTransactions_SalesInvoiceId",
                table: "CustomerTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_PurchaseInvoiceId",
